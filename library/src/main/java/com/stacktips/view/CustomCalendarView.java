...
public class CustomCalendarView extends DirectionalLayout {
    ...
    private void setDaysInCalendar() {
        ...
        int totalNumberOfDays = 42;
        int monthEndIndex = totalNumberOfDays - (actualMaximum + dayOfMonthIndex - 1);
        int[] dayOfMonthIds;
        for (int i = 1; i < totalNumberOfDays + 1; i++) {
            switch (i) {
                case 1 :
                ...
                case 15 :
                    ...
                    break;
                default:
                    switchSetDaysInCalendarExtended1(calendar, startCalendar, i, monthEndIndex);
                    break;
            }
        }
    ...
    private void switchSetDaysInCalendarExtended1(Calendar calendar, Calendar startCalendar, int dateIndex,
                                                  int monthEndIndex) {
        int[] dayOfMonthIds;
        switch (dateIndex) {
            case 16 :
            ...
            case 30 :
                ...
                break;
            default:
                switchSetDaysInCalendarExtended2(calendar, startCalendar, dateIndex, monthEndIndex);
                break;
        }
    }

    private void switchSetDaysInCalendarExtended2(Calendar calendar, Calendar startCalendar, int dateIndex,
                                                  int monthEndIndex) {
        int[] dayOfMonthIds;
        switch (dateIndex) {
            case 31 :
    ...
    private Component getView(Calendar currentCalendar) {
        ...
        switch (index) {
            ...
            case 15 :
                ...
                break;
            default:
                childView = switchGetViewExtended1(index);
                break;
        }
        return childView;
    }

    private Component switchGetViewExtended1(int index) {
        Component childView;
        switch (index) {
            case 16 :
            ...
            case 30 :
                ...
                break;
            default:
                childView = switchGetViewExtended2(index);
                break;
        }
        return childView;
    }

    private Component switchGetViewExtended2(int index) {
        Component childView;
        switch (index) {
            case 31 :
    ...
    private final ClickedListener onDayOfMonthClickListener = new ClickedListener() {
        ...
        public void onClick(Component view) {
            ...
            switch (tagId) {
                ...
                case "15" :
                    ...
                    break;
                default:
                    dayOfMonthText = onClickExtended1(tagId, view);
                    break;
            }
            // Fire event
        ...
        private Text onClickExtended1(String tagId, Component view) {
            final Text dayOfMonthText;
            switch (tagId) {
                case "16" :
                ...
                case "30" :
                    ...
                    break;
                default:
                    dayOfMonthText = onClickExtended2(tagId, view);
                    break;
            }
            return dayOfMonthText;
        }

        private Text onClickExtended2(String tagId, Component view) {
            final Text dayOfMonthText;
            switch (tagId) {
                case "31" :
